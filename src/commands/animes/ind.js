        ...
        msg.createReactionCollector({
            ...
            .on('collect', (reaction, user) => {
                ...
                if (reaction.emoji.name === emojis[1]) {
                    ...
                    return user.send({ embeds: [IndEmbed.setDescription(`From: ${message.guild.name}`)] }).then(() => {
